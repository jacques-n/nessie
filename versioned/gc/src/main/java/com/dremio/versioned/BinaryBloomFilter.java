 ...
 * <ol>
 * <li>format used when exposing a result to a row (direct use of Guava's readfrom operations)
 * <li>internal format used when doing aggregation (based on externalizable)
 * </ol>
 *
 */
